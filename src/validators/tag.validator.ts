...
export function createTagSchemas(config?: TagSchemaConfig): TagSchemas {
  ...
  const Create = z.object({
    ...
    name: z.string().min(1, t.validationTagNameRequired).max(maxName, t.validationTagNameMaxLength),
    description: z.string().max(maxDesc, t.validationTagDescriptionMaxLength).optional(),
  });
